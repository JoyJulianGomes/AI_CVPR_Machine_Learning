...
%Non vectorized Implementation; Takes more time
%{
intermediate_y = zeros(m, num_labels);
for i=1:size(y,1)
intermediate_y(i, y(i,1)) = 1;
end
y = intermediate_y;
%}

%Vectorized Implementation
yVec = [1:num_labels] == y; %Creates a matrix containing values 1,2..,num_labels
